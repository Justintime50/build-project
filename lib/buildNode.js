...
async function buildNodeProject(filepath) {
    ...
    try {
        ...
        await filesystem.createFile(`${filepath}/index.js`, '#!/usr/bin/env node\n');
        await filesystem.createFile(`${filepath}/package.json`, staticData.nodePackage);
